...
describe Admin::PostsController do
  ...
  let(:valid_attributes) { { page_title: "test", slug: "test" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # Admin::PostsController. Be sure to keep this updated too.
  let(:valid_session) { controller.stub(:authenticate_user!).and_return true }
  ...
  describe "GET new" do
    it "assigns a new admin_post as @admin_post" do
      ...
      assigns(:admin_post).should be_a_new(Post)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created admin_post as @admin_post" do
        post :create, {:post => valid_attributes}, valid_session
        assigns(:admin_post).should be_a(Post)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_post" do
        ...
        Post.any_instance.should_receive(:update).with({ "page_title" => "test2" })
        put :update, {:id => post.id, :post => { "page_title" => "test2" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_post as @admin_post" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Post.any_instance.stub(:save).and_return(false)
        put :update, {:id => post.id, :post => {  }}, valid_session
        assigns(:admin_post).should eq(post)
      end
